...
refer to https://docs.gitlab.com/ee/user/profile/personal_access_tokens.html and take the `read_user`

=== Get token from github
refer to https://docs.cachethq.io/docs/github-oauth-token and take the `read_user`
